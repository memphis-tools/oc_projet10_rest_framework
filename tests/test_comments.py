...
class TestCommentsCrudAndAuthorization:
    ...
    @pytest.mark.django_db
    def test_authenticated_user_create_comment_for_an_issue_without_being_part_of_project(
        self,
    ):
        """
    ...
    def test_authenticated_user_view_comment_for_an_issue_when_part_of_project(self):
        ...
        url = reverse(
            "comments_detail", kwargs={"pk": 1, "issue_id": 1, "comment_id": 1}
        )
    ...
    @pytest.mark.django_db
    def test_authenticated_user_view_comment_for_an_issue_when_not_part_of_project(
        self,
    ):
        """
    ...
    def test_authenticated_user_update_comment_for_an_issue_when_author(self):
        ...
        response = client.put(
            url,
            data=self.comment_data1_update,
            content_type="application/json",
            headers=headers,
        )
        assert response.status_code == 200
