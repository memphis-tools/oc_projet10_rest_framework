...
urlpatterns = [
    ...
    path('projects/<int:pk>/users/', ProjectsUsersAPIView.as_view(), name='projects_users'),
    path('projects/<int:pk>/users/<int:user_id>/', ProjectsUsersAPIView.as_view(), name='projects_users_detail'),
